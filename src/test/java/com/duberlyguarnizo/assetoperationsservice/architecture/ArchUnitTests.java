...
class ArchUnitTests {
  JavaClasses importedClasses = new ClassFileImporter()
      ...
      .importPackages("com.duberlyguarnizo.assetoperationsservice");
  ...
  @Test
  @DisplayName("Infrastructure ports should be interface implementations")
  void portsShouldBeAnnotatedWithPort() {
    ArchRule rule = classes().that().resideInAPackage("..port..")
        .should().beAnnotatedWith(Port.class);
    rule.check(importedClasses);
  }
